...
const Austria = () => {
  return (
    <div className="packages__content">
      <h3 className="packages__title">AUSTRIA</h3>
      ...
      <div className="packages__group">
          <div className="packages__data">
            ...
            <div>
              <h3 className="packages__name">100K</h3>
          ...
          <div className="packages__data">
            ...
            <div>
              <h3 className="packages__name">7655 EURO</h3>
              <span className="packages__level">Full scholarship</span>
            </div>
          </div>
